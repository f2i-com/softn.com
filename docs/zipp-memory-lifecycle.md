...
Checked on 12 September 2026 against the shipped ZIPP v0.0.17 artifact, revision
...
in v0.0.17. Pulling the current main does not require another WASM update here.
...
checkout it reported zero retained dynamic-function bytes in the first case and
